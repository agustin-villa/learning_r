...
temps_f <- c(90,100,85,92,95,88,98)
...
# Testing Function f_to_c(0) returned 17.778 
```
...
cities <- list(cancun = temps_f, london = c(35,40,45,50,60,30,45), chicago = c(80,90,95,92,98,100,77))
```
...
ggplot(stack(cities_df), aes(x = ind, y= values)) + geom_boxplot() + labs(x = "Cities", y = "Temperatures") + ggtitle("City Temperatures")
```
